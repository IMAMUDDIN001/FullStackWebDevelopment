...
// you need to remove all the duplicates from the array. You want to write a
// function that can accomplish this task efficiently and returns a new set
// that contains only the unique elements.
