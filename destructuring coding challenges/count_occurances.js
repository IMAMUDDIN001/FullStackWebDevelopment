...
// You are building a word count generator that will take a large string of
...
function countWords(str) {
    ...
    const sentence = "I am Imamuddin Shaikh. I am learning web development from PW Skills.";
